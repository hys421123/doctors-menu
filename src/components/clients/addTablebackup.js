...
import { DatePicker, Button, Table, Input, Popconfirm } from 'antd';
...
class EditableCell extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    // console.log('shouldComponentUpdate_vaule',nextState.value+"// "+this.state.value);

    // console.log('shouldComponentUpdate',nextProps.editable !== this.state.editable ||
  ...
  handleChange(e) {
    ...
    // console.log('tableCell_value',value);
  ...
  render() {
    ...
    // console.log('Cell_value_editable ',value+"/"+editable);
...
class AddTable extends React.Component {
  ...
  handleChange(key, index, value) {
    ...
    console.log('dataSource in addTable_', dataSource);
